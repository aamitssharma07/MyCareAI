...
st.set_page_config(
    ...
    menu_items={
        'Get Help': 'https://www.linkedin.com/in/aamit-datascientist/',
        'Report a bug': "https://www.linkedin.com/in/aamit-datascientist/",
    ...
    if not st.session_state['signedOut']:
        ...
        if choice == "Login":
            ...
            if login_submit:
                ...
                #             user_name = user_data.get("localId")
                ...
                #         else:
                #             st.error("Login Failed: " + response.json().get('error', {}).get('message', 'Unknown error'))
                ...
                def auth_user():
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            # st.warning(f"Login Failed: {error_msg}")  #For debugging
